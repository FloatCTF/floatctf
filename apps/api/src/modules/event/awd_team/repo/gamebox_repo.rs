//! GameBox template and instance repository.
...
use crate::entity::{
    awd_gamebox_instances, awd_gamebox_templates, sea_orm_active_enums::GameboxStatus,
};

// ── Templates ──

pub async fn find_templates_by_event(
    db: &DatabaseConnection,
    event_id: Uuid,
) -> Result<Vec<awd_gamebox_templates::Model>, sea_orm::DbErr> {
    awd_gamebox_templates::Entity::find()
