...
| 9 | Platform restart mid-event | Full stack restart during attack phase | Recovery service reconciles containers from DB; WG/firewall restore TODOs noted if incomplete; event phase preserved | ☐ |
...
- [ ] Phase switch flushes conntrack for the event.
